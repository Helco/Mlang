...
public readonly struct LiteralNumber
{
    ...
    public static IReadOnlyList<LiteralNumber> ArrayFor(byte[] vals)
    {
    ...
    public static IReadOnlyList<LiteralNumber> ArrayFor(int val) => ArrayFor(BitConverter.GetBytes(val));
    public static IReadOnlyList<LiteralNumber> ArrayFor(uint val) => ArrayFor(BitConverter.GetBytes(val));
    public static IReadOnlyList<LiteralNumber> ArrayFor(float val) => ArrayFor(BitConverter.GetBytes(val));
    public static IReadOnlyList<LiteralNumber> ArrayFor(long val) => ArrayFor(BitConverter.GetBytes(val));
    public static IReadOnlyList<LiteralNumber> ArrayFor(ulong val) => ArrayFor(BitConverter.GetBytes(val));
    public static IReadOnlyList<LiteralNumber> ArrayFor(double val) => ArrayFor(BitConverter.GetBytes(val));

    public static IReadOnlyList<LiteralNumber> Array(params uint[] vals) => vals.Select(v => new LiteralNumber(v)).ToArray();
